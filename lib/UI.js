  ...
  module.buildUI = function (thisObj) {
    ...
    var win =
      thisObj instanceof Panel
        ? thisObj
        : new Window(typeOfWindow, script.name, undefined, {
            resizeable: true,
          });
    win.alignChildren = ["fill", "top"];
    win.spacing = 5;

    var checkSingleFile = win.add(
      "checkbox",
      undefined,
      "Write binary strings into single file"
    );
    ...
    var checkAddFileDeclaration = win.add(
      "checkbox",
      undefined,
      "Add file object declaration"
    );
    ...
    var checkFileAfterBinary = win.add(
      "checkbox",
      undefined,
      "Declare file object after binary declaration"
    );
    ...
    var etBinaryPrefix = createEditText(
      panelBinary,
      "prefix",
      options.binaryVariablePrefix
    );
    var etBinarySuffix = createEditText(
      panelBinary,
      "suffix",
    ...
    var etFilePrefix = createEditText(
      panelFile,
      "prefix",
      options.fileVariablePrefix
    );
    var etFileSuffix = createEditText(
      panelFile,
      "suffix",
    ...
    var checkCompressPNG = panelCompress.add(
      "checkbox",
      undefined,
      "Compress PNG images"
    );
    ...
    var pathToPngquant = Os.isMac()
      ? options.pathToPngquantMac
      : options.pathToPngquantWin;
    var etPathToPngquant = grpPngquant.add(
      "edittext",
      undefined,
      pathToPngquant
    );
    ...
    btnPngquant.onClick = function () {
      var pngquant = File.openDialog(
        "Select pngquant executable",
        undefined,
        false
      );
      if (pngquant) {
    ...
    function readOptions() {
      ...
      options.fileAfterBinary =
        checkAddFileDeclaration.value && checkFileAfterBinary.value;
    ...
    var btnConvertDirectory = win.add(
      "button",
      undefined,
      "Convert Directory To Binary"
    );
    btnConvertDirectory.onClick = function () {
      readOptions();
      convertToBinary.directory();
    };
